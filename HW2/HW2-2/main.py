...
def creatEmptyList(size):
    return [0]*size

def creat2DList(size):
    result = []
    x = 0
    while x < size:
        result.append(creatEmptyList(size))
        x += 1
    return result
...
def printAllDDT( SBoxes ):
    for i in range(0,2):
        print("#### Differential Distribution Table of SBox-" + str(i) + " ####")
